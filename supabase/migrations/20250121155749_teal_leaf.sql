/*
  ...
  1. Tables
    ...
    - exchange_reservations: Store currency exchange reservations
...
DROP POLICY IF EXISTS "Users can view own reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Users can insert own reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Users can update own pending reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Users can delete own pending reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Admins can view all profiles" ON public.profiles;
DROP POLICY IF EXISTS "Admins can update all profiles" ON public.profiles;
DROP POLICY IF EXISTS "Admins can view all reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Admins can update all reservations" ON public.exchange_reservations;
DROP POLICY IF EXISTS "Admins can delete all reservations" ON public.exchange_reservations;
